  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none">
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <pre className="text-xs text-blue-400/10 font-mono whitespace-pre-wrap break-words p-8 h-full overflow-hidden">
          {pythonCode}
        </pre>
      </div>
      {/* Animated scan line effect */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-0 bg-gradient-to-b from-blue-500/0 via-blue-400/20 to-blue-500/0 animate-pulse"></div>
      </div>
    </div>
  );
}
